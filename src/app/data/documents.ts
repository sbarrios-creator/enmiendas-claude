...
export const baseDocuments: DocumentWithCategory[] = [
  ...
  { id: '2',   name: 'Consentimiento informado',             type: 'Instrumento', status: 'Aprobado', version: '1', category: 'Consentimiento informado y Asentimientos' },
  { id: '3',   name: 'Asentimiento(12-17)',                  type: 'Instrumento', status: 'Aprobado', version: '1', category: 'Consentimiento informado y Asentimientos' },
  { id: '4',   name: 'Asentimiento(<12)',                    type: 'Instrumento', status: 'Aprobado', version: '1', category: 'Consentimiento informado y Asentimientos' },
